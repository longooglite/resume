...
<template>
    <div class="the-technologies">
        ...
        <div class="technologies-list">
            <div class="technology" v-for="skill in sortedTechnicalSkills" :key="skill.name">
                <h3 class="technology-name">{{ skill.name }} <span class="technology-level">{{ skill.level }}/10</span></h3>
